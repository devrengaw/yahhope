...
export function Inventory() {
  ...
  const openItemModal = (item?: InventoryItem) => {
    if (item) {
      ...
      setEditingItem(null);
      setName(''); setCategory(categories[0]?.name || ''); setQuantity(''); setUnit(''); setMinQuantity(''); setExpirationDate(''); setPurchasePrice(''); setCurrency('MZN'); setInternalUse(false);
    }
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-24 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all"
                        placeholder="0.00"
                      />
                    </div>
                  </div>
